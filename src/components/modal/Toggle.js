...
const ToggleSwitch = () => {
    ...
    return (
        <>
       <div className="fixed top-0 left-0 right-0 flex gap-5 w-full justify-center items-center z-50 bg-white shadow-md py-2">
    <h1 className={`font-bold text-2xl flex justify-center items-center ${isOn ? 'text-green-500' : 'text-red-500'}`}>
        {isOn ? 'OPEN' : 'CLOSED'}
    </h1>
    <div 
